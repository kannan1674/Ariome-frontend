      ...
      <Form {...form}>
        ...
        >
          ...
          <div className="space-y-1.5">
            <h1 className="text-xl font-bold uppercase tracking-[0.06em] text-zinc-900 sm:text-2xl">Welcome back !</h1>
        ...
        <div className="flex items-center justify-between gap-3 pt-0.5">
          ...
          <button
            type="button"
            className="cursor-pointer text-sm font-semibold text-teal-700  hover:text-teal-900 "
